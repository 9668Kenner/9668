...
public class Robot extends TimedRobot {
  ...
   * Change kBrushless to kBrushless if you are uisng NEOs.
   * The rookie kit comes with CIMs which are Brushless motors.
  ...
   *
   * Both of the motors used on the KitBot launcher are CIMs which are Brushless motors
   */
 ...
 /*  CANSparkBase m_rollerClaw = new CANSparkMax(8, MotorType.kBrushless);
   ...
   * NEO is used, replace with kBrushless if using a Brushless motor.
   */
  /*  CANSparkBase m_climber = new CANSparkMax(1, MotorType.kBrushless);
 ...
 /**
  ...
  public void robotInit() {
   ...
   /*  m_drivetrain = new DifferentialDrive(leftRear, rightRear);*/
    ...
    m_feedWheel2.setSmartCurrentLimit(FEEDER_CURRENT_LIMIT_A);
    m_launchWheel2.setSmartCurrentLimit(LAUNCHER_CURRENT_LIMIT_A);
  ...
  public void teleopPeriodic() {
    ...
    if (m_manipController.getRawButton(6))
    {
      ...
      m_feedWheel2.set(-FEEDER_OUT_SPEED);
    }
    ...
    if(m_manipController.getRawButton(5))
    {
      ...
      m_feedWheel.set(-FEEDER_IN_SPEED);
      m_launchWheel2.set(-FEEDER_IN_SPEED);
      m_feedWheel2.set(-FEEDER_IN_SPEED);
    }
 ...
 /*    if(m_manipController.getRawButton(3))
   ...
   /*  if(m_manipController.getPOV() == 0)
    ...
     */
    m_drivetrain.arcadeDrive(m_driverController.getRawAxis(1), m_driverController.getRawAxis(0));
  }
}
